...
struct MandelState
{
    ...
    inline DDVec2 pos_128() const { return camera.pos<f128>(); }
    //inline f128 zoom_128() const { return camera.zoom<f128>(); }
    inline f128 relative_zoom() const { return camera.getRelativeZoom<f128>(); }
    inline double cam_angle() const { return camera.rotation(); }
    ...
    std::string serialize() const
    {
        ...
        if (version >= 0)
        {
            ...
            info["z"] = to_string(camera.getRelativeZoom<f128>(), 32);
